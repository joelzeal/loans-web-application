<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true" CodeBehind="ContributionsReport.aspx.cs" Inherits="LoanWebApplication4.admin.ContributionsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Investments Deposit Report</h2>
...
<div class="reportParamterSection">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" runat="server" 
        ...
        <LocalReport ReportPath="Reports\rptContributions.rdlc">
            <DataSources>
