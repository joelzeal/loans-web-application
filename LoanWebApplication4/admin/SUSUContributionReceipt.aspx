<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true" CodeBehind="SUSUContributionReceipt.aspx.cs" Inherits="LoanWebApplication4.admin.SUSUContributionReceipt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0">
        ...
        <rsweb:ReportViewer Width="100%" Height="700px" ID="ReportViewer1" 
            ...
            <LocalReport ReportPath="Reports\SUSUContributionReceipt.rdlc">
                <DataSources>
