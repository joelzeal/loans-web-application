<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true" CodeBehind="CustomerStatementReport.aspx.cs" Inherits="LoanWebApplication4.admin.CustomerStatementReport" %>
...
<div class="reportParamterSection">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" runat="server" 
        ...
        <LocalReport ReportPath="Reports\rptCustomerStatement.rdlc">
            <DataSources>
    ...
    <asp:SqlDataSource ID="ContributionsSqlDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:FinanceManagerConnectionString %>" 
        SelectCommand="SELECT * FROM [Contributions] WHERE ([InvestmentId] = @InvestmentID) ORDER BY [CreatedDate]">
        <SelectParameters>
