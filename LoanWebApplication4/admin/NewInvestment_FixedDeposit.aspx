<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true"
    CodeBehind="NewInvestment_FixedDeposit.aspx.cs" ValidateRequest="false" Inherits="LoanWebApplication4.admin.NewInvestment_FixedDeposit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        New 
        Fixed Deposit Investment<asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
    </h2>
    <br />
    <div >
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="style31" valign="top">
                            Investment Date:</td>
                        <td class="style24" valign="top">
                            <asp:TextBox ID="DurationTextBox0" runat="server" Style="text-align: right" 
                                Text='<%# Bind("Duration") %>' Width="250px" />
                            <asp:CalendarExtender ID="DurationTextBox0_CalendarExtender" runat="server" 
                                Enabled="True" TargetControlID="DurationTextBox0">
