<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true"
    CodeBehind="NewEmployeeLoan.aspx.cs" ValidateRequest="false" Inherits="LoanWebApplication4.admin.NewEmployeeLoan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        New 
        Employee Loan<asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
    </h2>
    <br />
    <div >
        Select a member from the 
        dropdown list below or add a new member to proceed.
    ...
    <table border="0" server="true" id="tblMember1" width="100%" runat="server" cellpadding="0" cellspacing="0">
        <tr>
            <td class="style30">
                    ...
                    <tr>
                        ...
                        <td class="style24">
                            ...
                            <asp:CompareValidator ID="CompareValidator5" runat="server" 
                                ControlToValidate="cboLoanType" ErrorMessage="*" Operator="NotEqual" 
                    ...
                    <tr>
                        ...
                        <td class="style19" valign="top">
                           <%-- <asp:TextBox ID="txtStartCalculationFrom" runat="server" Width="250px"></asp:TextBox>
                            ...
                            <uc1:DateWebUserControl ID="DateWebUserControlStartCalculationDate" runat="server" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style19" valign="top">
                           <%-- <asp:TextBox ID="txtLoanDate" runat="server" Width="250px"></asp:TextBox>
                            <asp:CalendarExtender ID="CalendarExtender123" 
                                runat="server" Enabled="True"
                                TargetControlID="txtLoanDate"></asp:CalendarExtender>--%>
                            <uc1:DateWebUserControl ID="DateWebUserControlLoanDate" runat="server" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
