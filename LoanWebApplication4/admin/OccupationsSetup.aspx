<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true" CodeBehind="OccupationsSetup.aspx.cs" Inherits="LoanWebApplication4.admin.OccupationsSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Occupations Setup</h2><br />
<div class="DataSection">
    <asp:FormView ID="FormView1" runat="server" DataKeyNames="LoanDurationId" 
        DataSourceID="OccupationsSqlDataSource" DefaultMode="Insert" Width="605px">
        <EditItemTemplate>
            LoanDurationId:
    ...
    <asp:SqlDataSource ID="OccupationsSqlDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:FinanceManagerConnectionString %>" 
        SelectCommand="SELECT * FROM [Occupations]" 
        DeleteCommand="DELETE FROM [Occupations] WHERE [OccupationID] = @OccupationID" 
        InsertCommand="INSERT INTO [Occupations] ([Description]) VALUES (@Description)" 
        
        UpdateCommand="UPDATE [Occupations] SET [Description] = @Description WHERE [OccupationID] = @OccupationID" 
...
<br />
    ...
    AutoGenerateColumns="False" CellPadding="4" DataKeyNames="OccupationID" 
    DataSourceID="OccupationsSqlDataSource" EmptyDataText="No data available." 
    ForeColor="#333333" GridLines="None" Width="100%">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Description" HeaderText="Occupation" 
