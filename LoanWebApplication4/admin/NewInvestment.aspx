<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true"
    CodeBehind="NewInvestment.aspx.cs" ValidateRequest="false" Inherits="LoanWebApplication4.admin.NewInvestment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        New Investment<asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
    </h2>
    <br />
    <div >
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="style31">
                            Investment Type:</td>
                        <td class="style24">
                            <asp:DropDownList ID="cboInvestmentDescription" runat="server" 
                                DataSourceID="InvestmentDescriptionSqlDataSource" DataTextField="Descriprion" 
                                DataValueField="InvestmentDecriptionId" 
                                ondatabound="cboInvestmentDescription_DataBound" Width="250px">
                            </asp:DropDownList>
                            <asp:CompareValidator ID="CompareValidator3" runat="server" 
                                ControlToValidate="cboInvestmentDescription" ErrorMessage="*" Operator="NotEqual" 
                                SetFocusOnError="True" style="color: #CC3300" ValidationGroup="g1" 
                                ValueToCompare="----Select----"></asp:CompareValidator>
                            <asp:SqlDataSource ID="InvestmentDescriptionSqlDataSource" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:FinanceManagerConnectionString %>" 
                                SelectCommand="SELECT [InvestmentDecriptionId], [Descriprion] FROM [InvestmentDecriptions] ORDER BY [Descriprion]">
                            </asp:SqlDataSource>
                        </td>
                        <td class="style27">
                            Contribution Frequency:</td>
                        <td class="style19">
                            <asp:SqlDataSource ID="PaymentFrequencySqlDataSource" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:FinanceManagerConnectionString %>" 
                                SelectCommand="SELECT * FROM [RepaymentFrequencies] ORDER BY [Description]">
                            </asp:SqlDataSource>
                            <asp:DropDownList ID="RepaymentFrequencyDropdownList" runat="server" 
                                DataSourceID="PaymentFrequencySqlDataSource" DataTextField="Description" 
                                DataValueField="RepaymentFrequencyId" 
                                OnDataBound="RepaymentFrequencyDropdownList_DataBound" 
                    ...
                    <tr>
                        ...
                        <td class="style24">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ...
                                ToolTip="Principal is required"></asp:RequiredFieldValidator>
                            &nbsp;<%--<asp:RegularExpressionValidator ID="RegularExpressionValidator1" 
                                runat="server" ControlToValidate="PrincipalTextBox" 
                        ...
                        <td class="style19">
                            ...
                            <asp:CalendarExtender ID="txtStartCalculationFrom_CalendarExtender" 
                                runat="server" Enabled="True" TargetControlID="txtStartCalculationFrom">
                            </asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                ControlToValidate="txtStartCalculationFrom" ErrorMessage="*" ForeColor="Red" 
                                ToolTip="Start calculation is required"></asp:RequiredFieldValidator>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style19">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                ...
                                ToolTip="Investment is required"></asp:RequiredFieldValidator>
                        </td>
                        <td>
                            &nbsp;
                        </td>
