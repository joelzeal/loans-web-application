...
{
    public partial class CashCollectionReportReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                txtEndDate_CalendarExtender.SelectedDate = DateTime.Today.Date;
                txtStartDate_CalendarExtender.SelectedDate = DateTime.Today.Date;
            }
