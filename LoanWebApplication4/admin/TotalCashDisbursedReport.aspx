<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true" CodeBehind="TotalCashDisbursedReport.aspx.cs" Inherits="LoanWebApplication4.admin.TotalCashDisbursedReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2> Cash Withdrawal Summary Report</h2>
...
<div class="reportParamterSection">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" runat="server" 
        ...
        <LocalReport ReportPath="Reports\rptCashDisbursedSummary.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="spGetDisbursedCashSqlDataSource" 
                    Name="DataSet1" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
    <asp:SqlDataSource ID="spGetDisbursedCashSqlDataSource" runat="server" 
        ConnectionString="<%$ ConnectionStrings:FinanceManagerConnectionString %>" 
        SelectCommand="GetCashDisbursedSummary" 
    SelectCommandType="StoredProcedure">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtEndDate" Name="EndDate" PropertyName="Text" 
                Type="DateTime" />
            <asp:ControlParameter ControlID="UsersDropDownList" Name="DisbursedBy" 
