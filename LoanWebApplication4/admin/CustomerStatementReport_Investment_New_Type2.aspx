<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true" CodeBehind="CustomerStatementReport_Investment_New_Type2.aspx.cs" Inherits="LoanWebApplication4.admin.CustomerStatementReport_Investment_New_Type2" %>
...
<div class="reportParamterSection">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="100%" runat="server" 
        ...
        <LocalReport ReportPath="Reports\rptCustomerStatement_Investment_new_Type2.rdlc">
            <DataSources>
    ...
    <asp:SqlDataSource ID="AppliedDeductionsSqlDataSource" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="" Name="InvestmentID" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
