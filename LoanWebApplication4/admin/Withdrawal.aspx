<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true"
    CodeBehind="Withdrawal.aspx.cs" Inherits="LoanWebApplication4.Withdrawal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="DataSection">
        <asp:FormView ID="FormView2" runat="server" DataKeyNames="MemberWithdrawalId" DataSourceID="WithdrawalHistorySqlDataSource1"
            DefaultMode="Insert" Width="552px">
            <EditItemTemplate>
                MemberWithdrawalId:
    ...
    <div class="DataSection">
        ...
        <asp:SqlDataSource ID="WithdrawalHistorySqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FinanceManagerConnectionString %>"
            ...
            InsertCommand="INSERT INTO MemberWithdrawals(MemberId, WithdrawalAmount, WithdrawnBy, WithdrawalIssuedByUserId, DateCreated, CreatedBy) VALUES (@MemberId, @WithdrawalAmount, @WithdrawnBy, @WithdrawalIssuedByUserId, GETDATE(), @CreatedBy)"
