<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true"
    CodeBehind="NewInvestment_MemberPreSelected.aspx.cs" ValidateRequest="false"
    Inherits="LoanWebApplication4.admin.NewInvestment_MemberPreSelected" %>
            ...
            <asp:View ID="View1" runat="server">
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td class="style24">
                            <asp:DropDownList ID="cboInvestmentDescription" runat="server" DataSourceID="InvestmentDescriptionSqlDataSource"
                                Width="250px" DataTextField="Descriprion" DataValueField="InvestmentDecriptionId"
                                OnDataBound="cboInvestmentDescription_DataBound">
                            </asp:DropDownList>
                            <asp:CompareValidator ID="CompareValidator4" runat="server" ControlToValidate="cboInvestmentDescription"
                            ...
                            <asp:SqlDataSource ID="InvestmentDescriptionSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:FinanceManagerConnectionString %>"
                                SelectCommand="SELECT [Descriprion], [InvestmentDecriptionId] FROM [InvestmentDecriptions] ORDER BY [Descriprion]">
                            </asp:SqlDataSource>
                        </td>
                        <td class="style27">
                        ...
                        <td class="style19">
                            ...
                            <asp:DropDownList ID="RepaymentFrequencyDropdownList" runat="server" DataSourceID="PaymentFrequencySqlDataSource"
                                DataTextField="Description" DataValueField="RepaymentFrequencyId" OnDataBound="RepaymentFrequencyDropdownList_DataBound"
                                OnSelectedIndexChanged="RepaymentFrequencyDropdownList_SelectedIndexChanged"
                                Width="250px">
                            </asp:DropDownList>
                            <asp:CompareValidator ID="CompareValidator8" runat="server" ControlToValidate="RepaymentFrequencyDropdownList"
                                ErrorMessage="*" Operator="NotEqual" SetFocusOnError="True" Style="color: #CC3300"
                                ValidationGroup="g1" ValueToCompare="----Select----"></asp:CompareValidator>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style24">
                            <asp:TextBox ID="PrincipalTextBox" runat="server" Style="text-align: right" Width="250px" />
                        ...
                        <td class="style19">
                            ...
                            <asp:CalendarExtender ID="txtStartCalculationFrom_CalendarExtender" runat="server"
                                Enabled="True" TargetControlID="txtStartCalculationFrom">
                            </asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtStartCalculationFrom"
                    ...
                    <tr>
                        ...
                        <td class="style24">
                            ...
                            <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToValidate="InterestTypeDropDownList"
                                ErrorMessage="*" Operator="NotEqual" SetFocusOnError="True" Style="color: #CC3300"
                                ValidationGroup="g1" ValueToCompare="----Select----"></asp:CompareValidator>
                        </td>
                        <td class="style27">
                            &nbsp;Investment Date:</td>
                        <td class="style19">
                            <asp:TextBox ID="txtInvestmentDate" runat="server" Width="250px"></asp:TextBox>
                            <asp:CalendarExtender ID="txtInvestmentDate_CalendarExtender" runat="server" 
                                Enabled="True" TargetControlID="txtInvestmentDate">
                            </asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                ControlToValidate="txtInvestmentDate" ErrorMessage="*" ForeColor="Red" 
                                ToolTip="Duration is required"></asp:RequiredFieldValidator>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style24" valign="top">
                            <asp:DropDownList ID="cboInterestDuration" runat="server" AutoPostBack="True" DataSourceID="InterestPresetsSqlDataSource"
                                ...
                                Width="250px" OnDataBound="cboInterestDuration_DataBound">
                            </asp:DropDownList>
                            <asp:CompareValidator ID="CompareValidator6" runat="server" ControlToValidate="cboInterestDuration"
                                ErrorMessage="*" Operator="NotEqual" SetFocusOnError="True" Style="color: #CC3300"
                                ValidationGroup="g1" ValueToCompare="----Select----"></asp:CompareValidator>
                    ...
                    <tr>
                        ...
                        <td class="style24">
                            ...
                            <asp:CompareValidator ID="CompareValidator7" runat="server" ControlToValidate="cboLoanDurationType"
                                ErrorMessage="*" Operator="NotEqual" SetFocusOnError="True" Style="color: #CC3300"
                                ValidationGroup="g1" ValueToCompare="----Select----"></asp:CompareValidator>
